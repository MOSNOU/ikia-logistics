...
export default async function BuyerFinanceSettlementDetailPage({ params }: PageProps) {
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline" size="sm">
            <Link href="/buyer/finance/settlements">بازگشت</Link>
          </Button>
          <Button asChild variant="outline" size="sm">
            <Link href={`/buyer/settlements/${id}`}>نمای عملیاتی</Link>
          </Button>
        </div>
      </div>
