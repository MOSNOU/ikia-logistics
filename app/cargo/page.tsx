...
export default function CargoListPage() {
  ...
  return (
    <div style={{minHeight:"100vh",fontFamily:"sans-serif",direction:"rtl",background:"#f9fafb"}}>
      <nav style={{padding:"16px",borderBottom:"1px solid #eee",background:"white",display:"flex",justifyContent:"space-between"}}><Link href="/" style={{fontSize:"24px",fontWeight:"bold",color:"#1B3A5C",textDecoration:"none"}}>🚛 iKIA</Link><Link href="/cargo/new" style={{color:"white",textDecoration:"none",fontSize:"14px",padding:"8px 16px",background:"#1B3A5C",borderRadius:"8px"}}>+ ثبت بار</Link></nav>
      <main style={{maxWidth:"800px",margin:"0 auto",padding:"24px 16px"}}>
        ...
        {loading ? <div style={{textAlign:"center",padding:"40px",color:"#999"}}>در حال بارگذاری...</div> : cargos.length===0 ? (
          ...
          <div style={{display:"flex",flexDirection:"column",gap:"12px"}}>
            {cargos.map(c=>(
              <div key={c.id} style={{background:"white",padding:"20px",borderRadius:"12px",border:"1px solid #eee"}}>
