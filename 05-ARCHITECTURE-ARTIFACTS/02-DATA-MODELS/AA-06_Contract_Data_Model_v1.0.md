...
Contract snapshots must be created at:
•	Final Draft Approval
•	Signature Completion
•	Amendment Approval
•	Settlement Completion
•	Contract Closure
Snapshots must be immutable and audit-protected.
...
15. Escrow and Settlement Integration
Contract may define:
•	Escrow rules
•	Payment milestones
•	Release conditions
...
Every contract lifecycle event must be auditable.
